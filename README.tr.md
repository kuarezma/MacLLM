...
| Sürüm | Öne çıkanlar |
|-------|----------------|
| **1.14.27** | Sohbet, model yükleme, indirme ve kullanıcıya görünen Türkçe hata akışlarında stabilite turu; llama köprüsünde daha savunmalı dönüşümler; kalite kapısı ve gerçek model smoke doğrulaması |
